...
import { DistanceMeasures } from "../components/EnsembleOverview";
...
const initialAppState = {
  ...
  /* Selected distance measure, affects which clusters are shown on the client.
  Only clusters generated by this distance measure are shown. By default, the 
  selected distance measure is hamming. */
  selectedDistanceMeasure: DistanceMeasures.HAMMING
}
...
export const AppStateActionType = {
  ...
  SET_SELECTED_DISTANCE_MEASURE: "SET_SELECTED_DISTANCE_MEASURE"
}
...
function appStateReducer(appState, action) {
  switch(action.type) {
    ...
    case AppStateActionType.SET_SELECTED_DISTANCE_MEASURE: {
      return {
        ...appState,
        selectedDistanceMeasure: action.payload,
        displayedBoundary: null,
        selectedClusterID: null
      }
    }
